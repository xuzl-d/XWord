...
PYBIND11_MODULE(_native, m) {
    ...
    py::class_<Document>(m, "Document")
        ...
        .def("save_detailed", py::overload_cast<const std::string&,const SaveOptions&>(&Document::saveDetailed), py::return_value_policy::reference_internal, py::arg("path"),py::arg("options")=SaveOptions())
